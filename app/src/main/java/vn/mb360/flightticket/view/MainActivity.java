...
import vn.mb360.flightticket.network.ApiClient;
import vn.mb360.flightticket.network.ApiService;
...
public class MainActivity extends AppCompatActivity implements TicketAdapter.TicketAdapterListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
         ...
         * First Flatmap convert single List<Ticket> to multiple emissions
     ...
     * get price HTTP call returns Price object, but map() operator is
     * used to change the return type to Ticket
     * Gọi Retrofit để lấy dữ liệu giá vé trên 1 api khác, mặc dù là trả về Price nhưng mà
     * sử dụng phương thức map() để chuyển đổi sang kiểu Ticket và gắn vô UI luôn. Vi diệu chưa.
     * */
    private ObservableSource<Ticket> getPriceObservable(final Ticket ticket) {
        return apiService
    ...
    public void onTicketSelected(Ticket ticket) {
        Snackbar snackbar = Snackbar.make(coordinatorLayout, ticket.getAirline().getName(), Snackbar.LENGTH_LONG);
